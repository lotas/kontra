...
// Usually a bright color (white, yellow etc)
	if (typeof fcolor == 'undefined') { var fcolor = "#e0e0FF";}
	
// Border color and color of caption
// Usually a dark color (black, brown etc)
	if (typeof backcolor == 'undefined') { var backcolor = "#006699";}
...
// 100-300 pixels is typical
	if (typeof width == 'undefined') { var width = "470";}
...
// Simple popup
function dts(d,text) {
	txt = "<TABLE style='position:absolute; left:250; top:10;' WIDTH="+width+" BORDER=0 CELLPADDING="+border+" CELLSPACING=0 BGCOLOR=\""+backcolor+"\"><TR><TD><TABLE WIDTH=100% BORDER=0 CELLPADDING=2 CELLSPACING=0 BGCOLOR=\""+fcolor+"\"><TR><TD><FONT FACE=\"Arial,Helvetica\" COLOR=\""+textcolor+"\" SIZE=\"-2\">"+text+"</FONT></TD></TR></TABLE></TD></TR></TABLE>"
	layerWrite(txt);
	dir = d;
	disp();
}
...
function layerWrite(txt) {
	if (overDivElm == null) overDivElm = document.getElementById('overDiv');
	overDivElm.innerHTML = txt;
	if (tr) { trk(); }
}
...
//      else if (ie4) obj.visibility = "hidden"
	...
	if (overDivElm == null) overDivElm = document.getElementById('overDiv');
	overDivElm.innerHTML = '';	
	overDivElm.style.display = 'none';
}
